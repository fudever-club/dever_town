...
export const FPTU_CLUBS = {
  ...
  itsc: {
    ...
    themeColor: '#38bdf8',
    icon: '💻',
    logoId: '1aLMuAxlHErqVKwrEo-p0rg8yEi9X9ww7',
  ...
  src: {
    ...
    themeColor: '#ef4444',
    icon: '🛡️',
    logoId: '1FlwT-lVtKe9y7LF8dL6md6qAnNt894Ig',
  ...
  dever: {
    ...
    themeColor: '#f97316',
    icon: '🚀',
    logoId: '1TKrwr8o0ur_xwacv893vmfWsKwR7395v',
  ...
  resup: {
    ...
    themeColor: '#10b981',
    icon: '🌱',
    logoId: '1lgEgjyYOruLpyCIRzPh6FClUhA9Axghi',
  ...
  fic: {
    ...
    themeColor: '#f59e0b',
    icon: '📈',
    logoId: '1jekhhTJmBWMJ0o3x-GZuSwBWNHYMuXU2',
  ...
  tss: {
    ...
    themeColor: '#6366f1',
    icon: '💡',
    logoId: '1uxoCGCNxiBff9u2VzVyd3lu7HSoKXQeq',
  ...
  mirai_jc: {
    ...
    themeColor: '#ec4899',
    icon: '🌸',
    logoId: '1IT8QRNuUe6LI2tgvxB8VpXaDQbyT4SNG',
  ...
  fkc: {
    ...
    themeColor: '#06b6d4',
    icon: '🇰🇷',
    logoId: '1xQ3c9b5KyJMlofXQI744_Yox1eKQsWYY',
  ...
  fucc: {
    ...
    themeColor: '#dc2626',
    icon: '🏮',
    logoId: '1OqKYibdnyy9bO2i88SD1uigaIdAEL2Iz',
  ...
  fcs: {
    ...
    themeColor: '#8b5cf6',
    icon: '🎨',
    logoId: '1VUKBqUukmAuQkVOetc8Vx7Se-S9IcZRy',
  ...
  fum: {
    ...
    themeColor: '#f43f5e',
    icon: '📸',
    logoId: '1KuUZZTi2yt-ryVBRG4NbwQbtM1UUe222',
  ...
  evo: {
    ...
    themeColor: '#0ea5e9',
    icon: '🎉',
    logoId: '1f8CQ3EBSw65Fx-jGiEuWSax_V4w276Ou',
  ...
  f2k: {
    ...
    themeColor: '#10b981',
    icon: '🤝',
    logoId: '1DaSDfFhSCkrDYMV1ktTJ8XN6cdxoUiXj',
  ...
  fenious: {
    ...
    themeColor: '#f97316',
    icon: '🍲',
    logoId: '1ShT_K9Ks5Z6LK5ECJEssebF3C45csXVM',
  ...
  tia: {
    ...
    themeColor: '#b45309',
    icon: '🪕',
    logoId: '1JSAQuGDtN-65Olm1bV_gmQ-hXEKr3cYw',
  ...
  rhythm: {
    ...
    themeColor: '#8b5cf6',
    icon: '🎵',
    logoId: '1NQRYfk7rR_8cHD2fncuD_8TB7GOt6OTC',
  ...
  mic: {
    ...
    themeColor: '#0284c7',
    icon: '🎙️',
    logoId: '1-sWXL51TFO8XCJSBt97QKbLKiNknEeyq',
  ...
  dfp: {
    ...
    themeColor: '#e11d48',
    icon: '💃',
    logoId: '1ZdJuCZtn1K032p0eGk0CyDoXtIfIZctf',
  ...
  noise_makers: {
    ...
    themeColor: '#a855f7',
    icon: '🕺',
    logoId: '1OeMH6JlmDtZZK-dVLHpCmZXZMEUe8GGQ',
  ...
  fhg: {
    ...
    themeColor: '#ea580c',
    icon: '🏀',
    logoId: '14w5oLrRfd8qO3b9V8_6QcEh_FKYvKvW6',
  ...
  fub: {
    ...
    themeColor: '#059669',
    icon: '🏸',
    logoId: '141GhkgpAbWITHtEvkaYyqQuuPnHgJpGL',
  ...
  fdn: {
    ...
    themeColor: '#ca8a04',
    icon: '🥢',
    logoId: '1dhzcM_Q_1Vr8ZbsE5AQXg6cHQr4eNF6w',
  ...
  vct: {
    ...
    themeColor: '#b91c1c',
    icon: '🥋',
    logoId: '1c9hAUIrnF32VKJ761EoXj3S-wsLteyg2',
  ...
  fvc: {
    ...
    themeColor: '#2563eb',
    icon: '🥋',
    logoId: '1nO0MDeI9VZ06XFXPHZDxOiQbj8WZsUgI',
